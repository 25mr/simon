...
def build_email_html(entries: List[Dict], with_translation: bool) -> str:
    ...
    f'<h1 style="margin:0;font-size:28px;line-height:1.1;font-weight:700;letter-spacing:2px;text-transform:uppercase;font-family:\'Arial Black\',\'Segoe UI Black\',\'Helvetica Neue\',Helvetica,Arial,\'PingFang SC\',\'Microsoft YaHei\',sans-serif;">🌶️ SIMON WILLISON</h1>'
